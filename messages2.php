			...
			while($row_user = mysqli_fetch_array($run_user)){
				...
				echo "
					<div class='container-fluid'>
						<a href='messages2.php?u_id=$user_id' style='text-decoration: none;cursor: pointer; color: #3897F0;'>
	...
	<div class="col-sm-6">
		...
		<?php 
			if(isset($_GET['u_id'])){
				...
				if($u_id=="new"){
					echo'
						<form>
							<center><h3>select someone</h3></center>
							<textarea disabled class="form-control" placeholder="type here"></textarea>
					...
					<form action="" method="post">
							<textarea class="form-control" placeholder="type here" name="msg_box" id="msg_textarea"></textarea>
							<input type="submit" name="send_msg" id="btn_msg" class="btn btn-default" value="send">
					</form><br><br>
					';
				}
			}
		...
		<?php 
			if(isset($_POST['send_msg'])){
				...
				if($msg==""){
					echo"<h4 style='color:red;text-align: center;'>message unable to send</h4>";
				}else if(strlen($msg)>37){
					echo"<h4 style='color:red;text-align: center;'>message should be 37 character below</h4>";
				}else{
			...
			<div class='col-sm-2'></div>
			 <center>
				<div style='background-color: #e6e6e6;' class='col-sm-9'>
					<h2>info about</h2>
					<img src='users/$user_image' width='150px' height='150'><br><br>
					<ul class='list-group'>
