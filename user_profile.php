...
<div class="row">
  ...
  <div class="col-sm-12">
  	...
  	<div class="col-sm-8">
  		<center>
  			<h1><strong><?php echo"$f_name $l_name";?></strong></h1>
  		</center>
  		<?php 
  			global $con;
			    ...
			    if($content=="No" && strlen($upload_image) >= 1){
			    		...
			    		<div id='own_posts'>
			    			<div class='row'>
			    				...
			    				<div class='col-sm-6'>
			    					...
			    					<h4><small style='color: black;'>Updated post a on </small><strong>$post_date</strong></h4>
			    				</div>
			    				<div class='col-sm-4'>
					...
					<div id='own_posts'>
					   ...
					   <div class='row'>
					    ...
					    <a href='single.php?post_id=$post_id' style='float:right';'><button class='btn btn-info'>Comment</button>
					</div><br><br>
